...
void ParticleSystem::Update()
{
	...
	// コップ（境界）のパラメータ
	float cupLeft = 440.0f;
	float cupRight = 840.0f;
	...
	// 【ステップ2】 粒子同士の衝突解決（密度の計算と押し出し）
	// ★ ここが流体シミュレーションの心臓部！次のステップでここにコードを書きます。
...
void ParticleSystem::Draw()
{
	...
	// コップの枠線を描画(確認用)
	Novice::DrawBox(440, 200, 400, 400, 0.0f, 0x555555FF, kFillModeWireFrame);
